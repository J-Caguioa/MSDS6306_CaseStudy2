...
# age, income, %salaryhike, yrsatcomp, yrscurrrole, yrssncpromo, yrswtcurmgr

# age
# 
summary(employee$Age)
ggAge = ggplot(employee, aes(Age))
ggAge = ggAge +geom_histogram(breaks=seq(20, 50, by=2), col="black", aes(fill=..count.., y=..density..)) 
...
data.frame(table(employee$Gender))
GenderData<-data.frame(table(employee$Gender))
names(GenderData) <- c("Gender", "Count")
GenderData
