...
package_list <- c("tidyverse", "readxl", "knitr", "mlr", "kableExtra", "corrplot", "ggmosaic", "magrittr", "caret", "randomForest", "reshape", "gridExtra", "GGally")
...
employee_money <- data.frame(rbind(c(min(employee_numeric$HourlyRate), max(employee_numeric$HourlyRate)),
...
grid.arrange(job_income, job_years_co, job_co_worked, job_sat, job_salinc, job_bal, ncol=3)
