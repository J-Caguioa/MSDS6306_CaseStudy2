...
knn_model <- train(Attrition~., train_subset, method='knn', trControl=train_control)
prediction_knn <- predict(knn_model, test_subset)
confusionMatrix(prediction_knn, test_subset$Attrition, positive="Yes")
...
* Sales Representatives, Laboratory Technicians, and Human Resources had the largest attrition percentages
* Sales Representatives are some of the youngest employees.
* Sales representative also have the lowest total working years, years in current role, years at current company and years with current manager
    

## Other considerations
Other considerations, such as next steps or other variables needed

Our recommendates upon completing this initial analysis are
