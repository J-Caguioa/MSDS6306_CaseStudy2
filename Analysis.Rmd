...
# Relationship between age and monthly income. [#4C]
...
softcolors <- c("#469990", "#E6BEFF", "#FFFAC8", "#800000", "#AAFFC3", "#FFD8B1", "#808000", "#000075", "#9A6324")
...
jobrole_age_a <- ContVsNomBoxplots(employee_factor, "JobRole", "Age") +
  scale_fill_manual("Job Roles", values=jobcolors)
